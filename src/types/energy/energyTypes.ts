...
export const EnergyCapFieldNames = {
  ...
  CAPNGUX: "ENERGY_CAPNGU-X",
  CAPATX: "ENERGY_CAPAT-X",
  CAPALLAT: "ENERGY_CAPALLAT",
  CAPBESTAUG: "ENERGY_CAPBESTAUG",
  CAPWAN: "ENERGY_CAPWAN",
  CAPBTX: "ENERGY_CAPBT-X",
  CAPALLBT: "ENERGY_CAPALLBT",
  CAPAUGX: "ENERGY_CAPAUG-X",
  CAPWISHX: "ENERGY_CAPWISH-X",
};
...
export enum EnergyCapFieldPriorities {
  ...
  CAPALLNGU = "ENERGY_CAPALLNGU_PRIORITY",
  CAPATX = "ENERGY_CAPAT_X_PRIORITY",
  CAPALLAT = "CAPALLAT_PRIORITY",
  CAPBESTAUG = "CAPBESTAUG_PRIORITY",
  CAPWAN = "CAPWAN_PRIORITY",
  CAPTM = "CAPTM_PRIORITY",
  CAPBTX = "CAPBT_X_PRIORITY",
  CAPALLBT = "CAPALLBT_PRIORITY",
  CAPAUGX = "CAPAUG_X_PRIORITY",
  CAPWISHX = "CAPWISH_X_PRIORITY",
}
